...
export class Backend implements backendInterface {
    ...
    async getAllContacts(arg0: string): Promise<Array<Inquiry>> {
    ...
    async getInquiryById(arg0: string, arg1: InquiryId): Promise<Inquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.getInquiryById(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<InquiryId> {
        if (this.processError) {
            try {
